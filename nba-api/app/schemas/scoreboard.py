...
class PlayerStats(BaseModel):
    ...
    points: float = Field(
        ..., ge=0, description="Points (game stats or season average PPG)."
    )
    rebounds: float = Field(
        ..., ge=0, description="Rebounds (game stats or season average RPG)."
    )
    assists: float = Field(
        ..., ge=0, description="Assists (game stats or season average APG)."
    )
...
class PlayerBoxScoreStats(BaseModel):
    ...
    rebounds_offensive: Optional[int] = Field(
        None, ge=0, description="Offensive rebounds."
    )
    rebounds_defensive: Optional[int] = Field(
        None, ge=0, description="Defensive rebounds."
    )
